      ...
      <section className="relative isolate min-h-162.5 overflow-hidden">
        ...
        <div className="container mx-auto grid min-h-162.5 items-center gap-14 px-5 py-16 sm:px-6 md:py-20 lg:grid-cols-[1.05fr_0.95fr] lg:px-8">
          ...
          <motion.div
            ...
            className="relative mx-auto w-full max-w-xl bg-[#fdfcfb]"
          >
            <video
              src="/ecosys.mp4"
              autoPlay
              ...
              playsInline
              preload="metadata"
              aria-label="TechCulture product ecosystem animation"
              className="fintech-ecosys-video h-auto w-full bg-[#fdfcfb] object-contain object-center"
            />
          </motion.div>
        </div>
      </section>
